...
public class ParserTest {
	...
	private static final String BURDEKIN_STATUS = "/ereefs/boxrenderer/xhtml/status_burdekin.xml";
	private static final String CAPE_YORK_STATUS ="/ereefs/boxrenderer/xhtml/status_capeyork.xml";
    ...
    public static void main(String[] args) throws Exception {
        Parser parser = new Parser(new Resolver() {
            ...
            public InputStream resolve(String name) throws Exception {
                return ParserTest.class.getResourceAsStream("/ereefs/boxrenderer/xhtml/"+name);
            }});
